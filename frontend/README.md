...
By default the frontend will call the Python API at `http://m4.netlob:8000` (CORS is enabled in the API).

If your API is on a different host/port:

- Create `frontend/.env.local`
- Set:
  - `VITE_API_HOST=http://m4.netlob:8000` (or whatever you use)
