...
HA_DRYER_JOB_STATE_ENTITY = os.environ.get("HA_DRYER_JOB_STATE_ENTITY", "sensor.dryer_job_state")
...
DOORBELL_FPS = 5
DOORBELL_PADDING = 50
DOORBELL_CONTENT_WIDTH = OUTPUT_WIDTH - 2 * DOORBELL_PADDING  # 980
DOORBELL_CORNER_RADIUS = 35

# Doorbell overlay colours
DOORBELL_BG = (250, 250, 252)
DOORBELL_HEADER_COLOR = (40, 40, 50)
DOORBELL_NAME_COLOR = (40, 40, 50)
DOORBELL_SUBTITLE_COLOR = (100, 100, 115)
DOORBELL_AVATAR_BG = (215, 215, 225)
DOORBELL_AVATAR_FG = (175, 175, 185)
DOORBELL_CAMERA_BG = (25, 25, 30)

# Doorbell overlay fonts
DOORBELL_HEADER_FONT_SIZE = 75
DOORBELL_NAME_FONT_SIZE = 55
DOORBELL_SUBTITLE_FONT_SIZE = 45
DOORBELL_AVATAR_SIZE = 180
